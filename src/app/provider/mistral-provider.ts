...
export function createMistral(options: MistralProviderSettings = {}): MistralProvider {
    const baseURL = withoutTrailingSlash(options.baseURL ?? options.baseUrl) ?? 'https://api.mistral.ai/v1';
    ...
    const createEmbeddingModel = (modelId: MistralEmbeddingModelId, settings: MistralEmbeddingSettings = {}) =>
